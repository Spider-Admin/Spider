...
public class FreenetTest {
	...
	public void getMessage() {
		...
		assertEquals("", Freenet.Error.getMessage(13));
		assertEquals("", Freenet.Error.getMessage(14));
		assertEquals("", Freenet.Error.getMessage(15));
		assertEquals("", Freenet.Error.getMessage(18));
		assertEquals("", Freenet.Error.getMessage(19));
		assertEquals("MalformedURLException", Freenet.Error.getMessage(20));
		assertEquals("", Freenet.Error.getMessage(28));
		assertEquals("", Freenet.Error.getMessage(30));
